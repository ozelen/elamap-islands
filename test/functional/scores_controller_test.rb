...
class ScoresControllerTest < ActionController::TestCase
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post :create, score: { student_id: @score.student_id, teacher_id: @score.teacher_id, text_id: @score.text_id, value: @score.value }
    end
  ...
  test "should update score" do
    put :update, id: @score, score: { student_id: @score.student_id, teacher_id: @score.teacher_id, text_id: @score.text_id, value: @score.value }
    assert_redirected_to score_path(assigns(:score))
  end
