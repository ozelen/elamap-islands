...
class TextsControllerTest < ActionController::TestCase
  ...
  test "should create text" do
    assert_difference('Text.count') do
      post :create, text: { author: @text.author, genre: @text.genre, lessons: @text.lessons, lexiles: @text.lexiles, name: @text.name }
    end
  ...
  test "should update text" do
    put :update, id: @text, text: { author: @text.author, genre: @text.genre, lessons: @text.lessons, lexiles: @text.lexiles, name: @text.name }
    assert_redirected_to text_path(assigns(:text))
  end
